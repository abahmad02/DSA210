...
# Load the HTML file
with open("message_5.html", "r", encoding="utf-8") as file:
    html_data = file.read()
...
user_messages.to_csv("your_messages_5.csv", index=False)
friend_messages.to_csv("friend_messages_5.csv", index=False)
